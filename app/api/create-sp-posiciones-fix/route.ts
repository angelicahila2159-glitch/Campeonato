...
export async function POST(request: NextRequest) {
  let connection;
  try {
    console.log('Creando Stored Procedure sp_ObtenerPosiciones...');
    ...
    await connection.query('DROP PROCEDURE IF EXISTS sp_ObtenerPosiciones');
    ...
    console.log('✓ Stored Procedure sp_ObtenerPosiciones creado exitosamente');
    ...
    console.error('Error creando Stored Procedure:', error);
    return NextResponse.json(
      {
        success: false,
